...
# ╔═╡ 52a47f2e-4b41-43e6-a715-ce5cc418c8b4
begin
	using Markdown
	using PlutoUI
...
# ╔═╡ c893ee3e-ee81-4bcd-908b-a0441f118bdf
...
# ╔═╡ ae7278e2-2acd-45ca-9dee-a3e224c73033
md"""> Repository and image services

"""

# ╔═╡ d2a3af13-11a5-4911-9ed6-e6ef52682c92
...
# ╔═╡ f62426d3-3333-4088-8cde-c20e0a6919cb
"""Base URL for an ImageCitationTool."""
function ict()
	"http://www.homermultitext.org/ict2/?"
end

# ╔═╡ 6286ec71-80f4-4e38-a702-29159a0138b7
...
# ╔═╡ 962c246a-a42e-4a7b-9764-5e0efddb07d6
...
# ╔═╡ 808d8ac3-3ff8-40c2-9989-91f5bc6ea318
...
# ╔═╡ a0384e93-9e0a-4b91-b483-9b242c847819
middict = begin
	loadem
	tomldict(joinpath(pwd(), "MID.toml"))
end

# ╔═╡ f0853326-f30c-41c3-bbfb-060638031574
begin
	loadem
...
# ╔═╡ 9059094d-91c7-4c54-a202-d6f637219cca
md"> Formatting"

# ╔═╡ f1a0883c-85a1-443d-9bd9-22f7632c6583
...
# ╔═╡ 1e02185a-4616-48a5-8077-145b76e38bed
begin
	if isnothing(surfaceurn)
		HTML(waiting())
	else
...
# ╔═╡ 0fd7203f-f8f5-4d73-9a66-6795188bd026
